...
const Hero = () => {
  ...
  const steps = [
    { label: "Application Submitted", value: "Analyzing data..." },
    { label: "AI Processing", value: "Running algorithms..." },
    { label: "Credit Score", value: "750" },
    { label: "Decision Made", value: "Approved" }
  ];
    ...
    if (currentStep === 2) {
      ...
      const timer = setInterval(() => {
        ...
        if (count >= target) {
          ...
          setCreditScore(Math.floor(count));
        }
      }, 16);
  ...
  return (
    <section id="home" className="pt-32 pb-20 bg-gradient-to-br from-cyan-50 via-blue-50 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative animate-slide-left">
            <div className="absolute -inset-4 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-2xl blur-2xl opacity-10 animate-pulse-slow"></div>
            
            <div className="relative bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 space-y-6 border border-blue-100">
                ...
                <div className="relative overflow-hidden">
                  ...
                  >
                    {steps.map((step, index) => (
                      <div 
                        key={index}
                        className="min-w-full flex flex-col items-center justify-center py-12"
                      >
                        <div className="text-sm text-gray-600 mb-2">{step.label}</div>
                        {index === 2 ? (
                          <div className="text-4xl font-light text-blue-600">{creditScore}</div>
                        ) : index === 3 ? (
                          <div className="flex items-center space-x-2">
                            <Check className="text-cyan-500" size={32} />
                            <span className="text-2xl font-light text-cyan-600">{step.value}</span>
                          </div>
                        ) : (
                          <div className="text-xl font-light text-gray-900">{step.value}</div>
                        )}
                      </div>
                    ))}
                  </div>
